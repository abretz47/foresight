...
import PuttingAssessmentModule from './trainingModules/PuttingAssessmentModule';
...
registerModule('putting-assessment', PuttingAssessmentModule); // TODO: replace with real component when ready